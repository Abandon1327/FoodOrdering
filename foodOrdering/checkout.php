   ...
   if($check_cart->rowCount() > 0){
      ...
      if($insert_order->rowCount() > 0){
       // Order inserted successfully
         ...
         $message[] = 'Order placed successfully!';
         header('Location: orders.php'); // Redirect to orders.php after placing the order
         exit(); // It's important to exit after a header redirect to prevent further script execution
      } else {
         // Handle errors if the order insertion fails
...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'disable';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
